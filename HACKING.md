...
hidden if the `buffalo_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `buffalo_DEVELOPER_MODE` to the configure
...
Runs the executable target `buffalo_exe`.
